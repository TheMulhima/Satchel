...
public static partial class Blueprints
{
    ...
    public static BetterMenus.InputField IntInputField(string name, Action<int> _storeValue, Func<int> _loadValue, string _placeholder = "", int _characterLimit = 6, Config.InputFieldConfig? _config = null,  string Id = "__Usename")
    {
